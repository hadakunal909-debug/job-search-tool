...
SUITES = (
    ...
    Suite("test_scrape_jd_rescue", "test_scrape_jd_rescue.py", "root", "offline"),
    Suite("test_score_persistence", "test_score_persistence.py", "root", "offline"),
    Suite("test_score_users_budget", "test_score_users_budget.py", "root", "offline"),
    Suite("test_score_fetch_deadline", "test_score_fetch_deadline.py", "root", "offline"),
    ...
    Suite("test_public_career_pages", "test_public_career_pages.py", "root", "offline"),
    Suite("test_trinethire", "test_trinethire.py", "root", "offline"),
    Suite("test_paycom", "test_paycom.py", "root", "offline"),
    Suite("test_adp", "test_adp.py", "root", "offline"),
    Suite("test_retry_unscrapeable", "test_retry_unscrapeable.py",        "root",   "offline"),
    Suite("test_scrape_partial",    "test_scrape_partial.py",            "root",   "offline"),
    ...
    Suite("test_ext_api",          "test_ext_api.py",                   "root",   "offline"),

...
flowchart TB
  subgraph REQ["&#9635; request-scoped"]
    W["<b>web.py</b><br/>9,933 lines · 87 routes / 86 handlers<br/>no blueprints"]
  ...
  SPINE["<b>THE SPINE</b> — imported by all three<br/>core.py · 4,513 lines · 36 sections<br/>db.py · 3,833 lines · four backends"]
  REQ --> SPINE
  SCH --> SPINE
  CLI --> SPINE
...
```mermaid
flowchart TB
  S["<b>the server feed</b><br/>web.py::_filter_rows<br/><i>line 2811</i>"]

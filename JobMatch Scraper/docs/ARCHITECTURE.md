...
flowchart TB
  ...
  SPINE["<b>THE SPINE</b> — imported by all three<br/>core.py · 4,513 lines · 36 sections<br/>db.py · 3,905 lines · four backends"]
  REQ --> SPINE
  SCH --> SPINE
  CLI --> SPINE
...
```mermaid
flowchart TB
  S["<b>the server feed</b><br/>web.py::_filter_rows<br/><i>line 2816</i>"]
